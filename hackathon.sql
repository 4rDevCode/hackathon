...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-09-2023 a las 17:08:03
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_set_encuentro` (`_Dia` VARCHAR(255), `_Horario` VARCHAR(255), `_MiembroFamilia` VARCHAR(255), `_PuntoEncuentro` VARCHAR(255), `_TiempoEspera` VARCHAR(255), `_familia_id` INT, OUT `_mensaje` VARCHAR(200))   BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
        ROLLBACK;
        SET `_mensaje` = 'Error al insertar el encuentro.';
    END;

    START TRANSACTION;

    INSERT INTO encuentros (Dia, Horario, MiembroFamilia, PuntoEncuentro, TiempoEspera, familia_id)
    VALUES (_Dia, _Horario, _MiembroFamilia, _PuntoEncuentro, _TiempoEspera, _familia_id);

    COMMIT;
    
    SET `_mensaje` = 'Encuentro insertado exitosamente.';
END$$
...
CREATE TABLE `encuentros` (
  ...
  `MiembroFamilia` varchar(255) NOT NULL,
...
(1, 2, '75730672', 'F. Calderón', 'Jefrinsson J', 'jefrinssonjfcalderon@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '969890984', NULL, 'R', '2023-04-19 14:54:27'),
(2, 0, '00000000', 'Temporal', 'Temporal', 'temporal@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '987665484', NULL, 'R', '2023-04-19 15:13:06'),
(3, 0, '65959595', 'Apellidos Temporal', 'Usuario Temporal', 'usuariotemporal@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '998713234', NULL, 'R', '2023-04-21 07:38:14'),
(4, 0, '75859565', 'User3', 'User2', 'user2@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '917876654', NULL, 'R', '2023-04-21 08:46:51'),
(5, 1, '6565651', 'jhsada', 'hola', 'nobucix@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '989765442', NULL, 'R', '2023-04-21 12:12:11'),
(6, 2, '32659865', 'BleBle Bleleee', 'Blablabla', 'admin@gmail.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '998324233', NULL, 'R', '2023-04-21 12:18:02'),
(7, 1, '45784512', 'Vnokasdm', 'Blejilln', 'adminnnn@link.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '998324533', NULL, 'R', '2023-04-21 12:20:58'),
(8, 2, '32659861', 'EmptyEmpty', 'Empty', 'empty@email.com', '93e94a8d8af48fc7afe5d04d5ff9e90a', '967886622', NULL, 'R', '2023-04-21 12:21:54');
...
--
ALTER TABLE `encuentros`
  ADD CONSTRAINT `encuentros_ibfk_1` FOREIGN KEY (`familia_id`) REFERENCES `tbl_familia` (`id`);
COMMIT;
